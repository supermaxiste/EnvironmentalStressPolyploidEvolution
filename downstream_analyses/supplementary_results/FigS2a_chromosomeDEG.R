...
HM_RS7K_G1_1_hal_dens <- read.csv(paste0(folder_path, "HM_RS7K_G1_1_hal_dens.txt"))
HM_RS7K_G1_2_hal_dens <- read.csv(paste0(folder_path, "HM_RS7K_G1_2_hal_dens.txt"))
HM_RS7K_G1_3_hal_dens <- read.csv(paste0(folder_path, "HM_RS7K_G1_3_hal_dens.txt"))

HM_RS7K_G1_1_lyr_dens <- read.csv(paste0(folder_path, "HM_RS7K_G1_1_lyr_dens.txt"))
HM_RS7K_G1_2_lyr_dens <- read.csv(paste0(folder_path, "HM_RS7K_G1_2_lyr_dens.txt"))
HM_RS7K_G1_3_lyr_dens <- read.csv(paste0(folder_path, "HM_RS7K_G1_3_lyr_dens.txt"))
...
hal_totC_dens <- read.delim("~/path/to/data/Fig4c/hal_totC_dens.txt")
lyr_totC_dens <- read.delim("~/path/to/data/Fig4c/lyr_totC_dens.txt")
...
DEGs_karyoploter <- function(deg_output, 
  ...
  annotation_import <- function(side){
    if(side=="hal"){
      anno <- read.delim("~/path/to/data/Fig6/hal_MAKER_PASA_46264_noTEs.gff",
                         header=FALSE,
      ...
      anno <- read.delim("~/path/to/data/Fig6/lyr_r2_MAKER_28737_8chr_renamed.gff",
                         header=FALSE,
                         col.names = c("chromosome", 
                                       "tool", 
                                       "context", 
...
homeo_region_HM <- read.delim("~/path/to/data/Fig4c/homeo_HM_overlap_continuous.txt", sep = " ")
homeo_region_LL <- read.delim("~/path/to/data/Fig4c/homeo_LL_overlap_continuous.txt", sep = " ")
nonhomeo_region_HM <- read.delim("~/path/to/data/Fig4c/nonhomeo_HM_overlap_continuous.txt", sep = " ")
nonhomeo_region_LL <- read.delim("~/path/to/data/Fig4c/nonhomeo_LL_overlap_continuous.txt", sep = " ")
...
MILD_PvsS1_hal <- fread("~/path/to/data/FigS2b/HM_SYN1vPRO1_hal_dens.txt")
MILD_PvsS4_hal <- fread("~/path/to/data/FigS2b/HM_SYN4vPRO1_hal_dens.txt")
MILD_PvsS1_lyr <- fread("~/path/to/data/FigS2b/HM_SYN1vPRO1_lyr_dens.txt")
MILD_PvsS4_lyr <- fread("~/path/to/data/FigS2b/HM_SYN4vPRO1_lyr_dens.txt")

STRESS_PvsS1_hal <- fread("~/path/to/data/FigS2b/LL_SYN1vPRO1_hal_dens.txt")
STRESS_PvsS4_hal <- fread("~/path/to/data/FigS2b/LL_SYN4vPRO1_hal_dens.txt")
STRESS_PvsS1_lyr <- fread("~/path/to/data/FigS2b/LL_SYN1vPRO1_lyr_dens.txt")
STRESS_PvsS4_lyr <- fread("~/path/to/data/FigS2b/LL_SYN4vPRO1_lyr_dens.txt")
