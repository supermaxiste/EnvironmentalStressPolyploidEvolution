...
### Import first set of files, progenitors vs natural ALK G1 (HM conditions)

setwd("/Users/ste/Library/CloudStorage/OneDrive-Personal/PhD/Project/Chapter_3/new_DMR_results/ARPEGGIO_results_alk1Vpro1_HM/dmrseq")
...
### Import first set of files, progenitors vs natural ALK G4 (HM conditions)

setwd("/Users/ste/Library/CloudStorage/OneDrive-Personal/PhD/Project/Chapter_3/new_DMR_results/ARPEGGIO_results_alk4Vpro1_HM/dmrseq")
#setwd("MILD_alk4_v_pro1/dmrseq")
dmrseq_output_CG_hal <- fread("CG_context/parent1_v_allo.txt")
dmrseq_output_CHG_hal <- fread("CHG_context/parent1_v_allo.txt")
dmrseq_output_CHH_hal <- fread("CHH_context/parent1_v_allo.txt")
dmrseq_output_CG_lyr <- fread("CG_context/parent2_v_allo.txt")
