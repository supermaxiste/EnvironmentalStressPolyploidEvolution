...
knitr::opts_chunk$set(echo = TRUE,
                      ...
                      dev = c("png"),
                      dpi=600)
output_path <- c("~/OneDrive/PhD/Project/Chapter_3/Reports/RNAseqDEG_v2/")
```
...
HM_lowC_genes_hal <- read.table("~/data/FigS6-7/HM_lowC_genes_hal.txt", quote="\"", comment.char="")
HM_lowC_genes_lyr <- read.table("~/data/FigS6-7/HM_lowC_genes_lyr.txt", quote="\"", comment.char="")

LL_lowC_genes_hal <- read.table("~/data/FigS6-7/LL_lowC_genes_hal.txt", quote="\"", comment.char="")
LL_lowC_genes_lyr <- read.table("~/data/FigS6-7/LL_lowC_genes_lyr.txt", quote="\"", comment.char="")
