...
covgz_avg_fun <- function(hal_or_lyr){
  if (hal_or_lyr == "hal"){
    covgz_average <- data.frame(hal_G1 = apply(window_scores_df[,1:2], 1, mean),
                                hal_G4 = apply(window_scores_df[,3:4], 1, mean),
                                RS7_G1 = apply(window_scores_df[,5:7], 1, mean),
                                RS7_G4 = apply(window_scores_df[,8:10], 1, mean),
                                ALK_G1 = apply(window_scores_df[,11:13], 1, mean),
                                ALK_G4 = apply(window_scores_df[,14:16], 1, mean),
                                TKS_G1 = apply(window_scores_df[,17:19], 1, mean),
                                TKS_G5 = apply(window_scores_df[,20:22], 1, mean))
    return(covgz_average)
  }
  else{
    covgz_average <- data.frame(lyr_G1 = apply(window_scores_df[,1:2], 1, mean),
                                lyr_G4 = apply(window_scores_df[,3:4], 1, mean),
                                RS7_G1 = apply(window_scores_df[,5:7], 1, mean),
                                RS7_G4 = apply(window_scores_df[,8:10], 1, mean),
                                ALK_G1 = apply(window_scores_df[,11:13], 1, mean),
                                ALK_G4 = apply(window_scores_df[,14:16], 1, mean),
