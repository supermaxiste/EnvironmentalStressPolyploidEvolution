...
Ahal_anno_path <- c("hal_MAKER_PASA_46264_noTEs.gff")
Alyr_anno_path <- c("lyr_MAKER_PASA_41817_renamed.gff")
# Path to file with low coverage genes
low_coverage_genes <- c("downstream_analyses/main_results/data/Fig4c/")
# Path to count tables (featureCounts output)
count_tables <- c("Fig6/counts")
